...
| Camping (Phase 5, shipped 2026-05-15) | Search + tracking. `lib/reccgov/*` (types, regions, REST client, deep-link), `lib/iOverlander/cache.ts`, `lib/campingState.ts`, sheet "Camping Index" mirror, `apps/cron/camping/*` (4 ticks via per-minute Railway service), 8 new Telegram commands, `find_free_campsites` agent tool. See `docs/superpowers/specs/2026-05-15-phase-5-camping-design.md`. |
