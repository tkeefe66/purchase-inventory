...
- **Rec.gov rate limit.** RIDB's keyed limit is 5000/hour. The seed makes ~N+1 calls (≤300 for CO). Fine. Monthly metadata refresh hits N facilities sequentially; also fine.
